...
class AppTheme {
  ...
  static ThemeData _build({required bool isDark}) {
    ...
    final inputFill = isDark ? const Color(0xFF252540) : const Color(0xFFF0F0F5);
    final inputBorder = isDark ? const Color(0xFF2A2A50) : const Color(0xFFE0E0E8);
    ...
    return ThemeData(
      ...
      colorScheme: isDark
          ? ColorScheme.dark(primary: primaryColor, secondary: blueColor, surface: card, error: redColor)
          : ColorScheme.light(primary: primaryColor, secondary: blueColor, surface: card, error: redColor),
      appBarTheme: AppBarTheme(
        backgroundColor: bg, elevation: 0, scrolledUnderElevation: 0,
        centerTitle: true, foregroundColor: text,
        titleTextStyle: TextStyle(color: text, fontSize: 20, fontWeight: FontWeight.bold, letterSpacing: 0.3),
      ),
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        ...
        showSelectedLabels: true, showUnselectedLabels: true, elevation: 0,
        type: BottomNavigationBarType.fixed,
      ),
      textTheme: TextTheme(
        headlineLarge: TextStyle(color: text, fontSize: 28, fontWeight: FontWeight.bold, letterSpacing: -0.5),
      ...
      dialogTheme: DialogThemeData(
        backgroundColor: card, elevation: 8,
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        errorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide(color: redColor, width: 1)),
        focusedErrorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide(color: redColor, width: 2)),
        labelStyle: TextStyle(color: subtitle), hintStyle: TextStyle(color: subtitle),
      ...
      extensions: <ThemeExtension>[
        AppColorsExtension(
          cardColor: card, textColor: text, subtitleColor: subtitle,
          insideButtonColor: Colors.white, shadowColor: shadow,
        ),
      ],
    );
  }
