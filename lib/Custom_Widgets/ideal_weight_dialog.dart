              ...
              children: [
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('${idealWeight.toStringAsFixed(1)} kg',
                          style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold, color: blueColor)),
                    ],
                  ),
                ),
                const SizedBox(height: 20),
                      ...
                      Column(
                        children: [
                          Text(isOverweight ? 'To Lose' : 'To Gain',
                              style: TextStyle(fontSize: 12, color: isOverweight ? Colors.red : Colors.green)),
                          const SizedBox(height: 8),
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(fontSize: 12, color: isOverweight ? Colors.red[700] : Colors.green[700]),
